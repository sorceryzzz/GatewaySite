...
namespace Dinlun.GatewaySite.Common{
...
public abstract class DbHelperMySql
{
    ...
    {
        MySqlParameter[] parm = { 
                                   DbHelperMySql.CreateInParam("@CurrentIndex",  MySqlDbType.Int32,      4,      CurrentIndex    ),
                                   DbHelperMySql.CreateInParam("@PageSize",      MySqlDbType.Int32,      4,      PageSize        ),
                                   DbHelperMySql.CreateInParam("@WhereSql",      MySqlDbType.VarChar,  2500,    WhereSql        ),
                                   DbHelperMySql.CreateInParam("@TableName",     MySqlDbType.VarChar,  20,     TableName       ),
                                   DbHelperMySql.CreateInParam("@Column",        MySqlDbType.VarChar,  2500,    Columns         ),
                                   DbHelperMySql.CreateInParam("@Sort",          MySqlDbType.VarChar,  50,     GetSort(Sort)   ),
                                   DbHelperMySql.CreateOutParam("@RecordCount",  MySqlDbType.Int32,      4                       )
                                   };
        return parm;
    }
    /// <summary>
    ...
    public static MySqlParameter[] GetCountParm(string TableName, string Columns, string WhereSql)
    {
        MySqlParameter[] parm = { 
                                   DbHelperMySql.CreateInParam("@TableName",     MySqlDbType.VarChar,  20,     TableName       ),
                                   DbHelperMySql.CreateInParam("@CountColumn",  MySqlDbType.VarChar,  20,     Columns         ),
                                   DbHelperMySql.CreateInParam("@WhereSql",      MySqlDbType.VarChar,  250,    WhereSql        ),
                                   DbHelperMySql.CreateOutParam("@RecordCount",  MySqlDbType.Int32,      4                       )
                                   };
        return parm;
    }
